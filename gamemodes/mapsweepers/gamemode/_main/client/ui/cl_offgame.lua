	...
	-- Lobby {{{
		...
		function jcms.offgame_BuildInfoTab(tab)
			...
			-- Credits {{{
				...
				thanks.peopleList = { "UberJ", "Acheron Panda", "Ady", "Basto3456", "bonsto", "CadetTrev", "lordpatek", "luigikart87", "Malyko", "mr.murdersalot", "oreiboon", "sgt_sas1905", "TalonSolid/Redline", "TH3L0AD3R", "TheOfficialJaydee", "Triaki", "nonsensicalhumanoid", "Szabi", "emnil", "paulchartres", "Endy0396", "Marum", "Pushnidze", "thecraftianman", "Redox", "boblikut", "ralstain6374", "CturiX", "Warkin Iskander Volselli", "Kpotovich" }
